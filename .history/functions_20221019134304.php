	...
	acf_add_local_field_group(array(
		...
		'fields' => array (
            ...
            array (
				'key' => 'field_3_4',
				'label' => 'FAQ',
				'name' => 'product_faq_checkout',
				'type' => 'repeater',
                'sub_fields' => array (
                    array (
                        'key' => 'field_3_4_1',
                        'label' => 'Product FAQ Question',
				        'name' => 'product_faq_question_checkout',
				        'type' => 'text',
                    ),
                    array (
                        'key' => 'field_3_4_2',
                        'label' => 'Product FAQ Anwser',
				        'name' => 'product_faq_anwser_checkout',
				        'type' => 'wysiwyg',
                    ),
				),
			),
...
function my_acf_add_local_field_groups4() {
	...
	acf_add_local_field_group(array(
		...
		'fields' => array (
			...
			array (
				'key' => 'field_4_8',
				'label' => 'Yellow box title',
				'name' => 'yellow_box_title_upsell',
				'type' => 'text',
			),
			array (
				'key' => 'field_4_9',
				'label' => 'Toggle Yellow box title',
				'name' => 'toggle_yellow_box_title_upsell',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
			...
			array (
				'key' => 'field_4_10',
				'label' => 'Yellow box subtitle',
				'name' => 'yellow_box_subtitle_upsell',
				'type' => 'text',
			),
			array (
				'key' => 'field_4_11',
				'label' => 'Toggle Yellow box subtitle',
				'name' => 'toggle_yellow_box_subtitle_upsell',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
			...
			array (
				'key' => 'field_4_12',
				'label' => 'Yellow box image',
				'name' => 'yellow_box_image_upsell',
				'type' => 'image',
			),
			array (
				'key' => 'field_4_13',
				'label' => 'Yellow box content',
				'name' => 'yellow_box_content_upsell',
				'type' => 'wysiwyg',
			),
			array (
				'key' => 'field_4_14',
			...
			array (
                ...
                'sub_fields' => array (
                    array (
                        'key' => 'field_4_16_1',
                        'label' => 'Testimonial name',
				        'name' => 'testimonial_name_upsell',
				        'type' => 'text',
                    ),
                    array (
                        'key' => 'field_4_16_2',
                        'label' => 'Testimonial text',
				        'name' => 'testimonial_text_upsell',
				        'type' => 'text',
                    ),
					array (
                        'key' => 'field_4_16_3',
                        'label' => 'Testimonial image',
				        'name' => 'testimonial_image_upsell',
				        'type' => 'image',
                    ),
				),
			),
