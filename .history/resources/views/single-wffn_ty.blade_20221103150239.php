...
<?php
    $link_url = $buttonLinkThankYou['url'];

?>
 <a href="<?php echo esc_url($link_url); ?>" class="bg-primary hover:bg-hover text-white font-bold p-4 rounded no-underline">{{$buttonTextThankYou}}</a>
 <p class="mt-10">
