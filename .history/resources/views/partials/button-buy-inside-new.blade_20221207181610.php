      ...
      <?php
        ...
        <div class="flex flex-col md:flex-row items-center">
            ...
            <?php if($price_sales > 0){
                echo "<div class='flex md:text-3xl text-xl mr-2 ml-2 font-normal !no-underline uppercase text-white items-center'>" .  "$"  . $price_sales . "&nbsp" . "<div class='text-xl mr-2 ml-2 font-normal line-through pt-1'>" . "$" . $price . "</div>" . "</div>" ;
            }
        else{
            echo $price . "$";
        }?>
