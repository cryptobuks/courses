<button id="moving-buy-button" class="relative block  w-1/2 text-center cursor-pointer">
      ...
      <!-- text -->
      <div class="relative bottom text-xl font-semibold leading-none tracking-wider py-4 px-10 bg-primary border-1 border-black rounded-full transform hover:translate-y-1 transition duration-200 ease-in-out">
      <?php
