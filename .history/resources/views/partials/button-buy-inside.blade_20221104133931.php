<button id="moving-buy-button" class="bg-primary w-full rounded-4xl md:rounded-full p-8 text-center block md:flex justify-center text-black align-center drop-shadow-md shadow-primary  ">
    <?php
