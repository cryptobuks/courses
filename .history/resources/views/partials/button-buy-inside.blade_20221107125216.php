<button id="moving-buy-button" class="relative block m-10 w-1/2 text-center cursor-pointer">
      ...
      <div class="absolute inset-x-0 bottom-1   border border-gray-500 rounded-lg" />

      <!-- text -->
      <div class="relative bottom-1 text-xl font-thin leading-none tracking-wider py-4 px-10 bg-primay border border-gray-500 rounded-lg transform hover:translate-y-1 transition duration-200 ease-in-out">
      <?php
