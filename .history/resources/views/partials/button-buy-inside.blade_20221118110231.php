      ...
      <?php
        ...
        <div class="flex flex-row">
            ...
            <?php if($price_sales > 0){
                echo "<div class='flex md:text-3xl text-xl mr-2 ml-2 font-bold !no-underline uppercase text-black'>" .  "$"  . $price_sales . "&nbsp" . "<div class='text-xl mr-2 ml-2 font-medium line-through pt-1'>" . "$" . $price . "</div>" . "</div>" ;
            }
        else{
            echo $price . "$";
        }?>
