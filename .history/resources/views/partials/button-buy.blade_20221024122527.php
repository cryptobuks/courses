<section class="w-full p-4 mx-auto">
    <button id="moving-buy-button" class="bg-primary w-full rounded-3xl flex p-4 text-center bg-primary hover: font-bold py-2 px-4 border-b-4 border-primary hover:border-primary rounded">
        <?php
