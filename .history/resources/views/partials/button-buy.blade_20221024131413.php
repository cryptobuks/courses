<section class="w-full p-4 mx-auto">
    <button id="moving-buy-button" class="bg-primary w-full rounded-3xl p-4 text-center flex justify-center text-black align-center drop-shadow-md shadow-primary animate-rocking">
        <?php
