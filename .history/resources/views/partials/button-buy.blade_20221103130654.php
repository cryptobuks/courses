<section class="w-full p-4 mx-auto animate-rocking">
   ...
   // $page = base_url(TRUE);
    ...
    <a href="?wffn-next-link=yes">
        <button id="moving-buy-button" class="bg-primary w-full rounded-3xl p-8 text-center flex justify-center text-black align-center drop-shadow-md shadow-primary no-underline ">
            <?php
