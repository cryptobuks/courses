...
<div class="bg-white w-full p-4  items-center flex justify-between mx-auto  max-w-pageWidth fixed" x-data="{showBar: false}" @scroll.window="showBar = (window.pageYOffset > 20) ? true : false" >
<nav >
