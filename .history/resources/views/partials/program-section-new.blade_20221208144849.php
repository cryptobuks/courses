            ...
            <div id="product-info" class="border-4 border-primary !rounded-lg border-t-40 relative">
                <div class="bg-primary p-2 relative">
                   ...
                   @include('partials.countdown-sales')
                    ...
                    <div class=" block !rounded-lg p-4 md:!pl-10 md:!pr-10">
                        <div class="fill-primary flex h-4 items-center justify-center">
                            ...
                            <?php
                                ...
                                if($price_sales > 0){
                                    echo "<div class='text-red-500 text-xl mr-2 ml-2 font-bold uppercase'> only " . "$"  . $price_sales ."</div>" ."<div class='text-red-500 text-xl mr-2 font-bold uppercase'> today" . "&nbsp" . "</div>" . "<div class='text-xs mr-2 ml-2 mt-1 font-medium line-through'>" .  "LIST PRICE" . " $" .  $price . "</div>";
                                }
                                else{
                                    echo $price . "$";
                                }
                    ...
                    <img class="h-32 hidden md:visible md:absolute md:-right-16 md:top-8" src="/wp-content/themes/courses-1/resources/images/parenting-award.png"></img>
            </div>
