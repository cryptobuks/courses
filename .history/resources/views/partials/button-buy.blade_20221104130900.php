        ...
        <button id="moving-buy-button" class="bg-primary w-full rounded-3xl md:rounded-full p-8 text-center block md:flex justify-center text-black align-center drop-shadow-md shadow-primary  ">
            <?php
               ...
               <?php if($price_sales > 0){
                    echo "<div class='text-3xl mr-2 ml-2 font-semibold !no-underline uppercase'> Join the challange " . "$"  . $price_sales . "&nbsp" . "</div>" . "<div class='md:text-xl !text-sm mr-2 ml-2 font-medium line-through pt-1'>" . "$" . $price . "</div>";
                }
                else{
                    echo $price . "$";
                }
