<section class=" mx-auto flex justify-center mt-10 max-w-contentwidth">
    <div class=" border-dashed border-2 border-green-600 rounded p-8 bg-green-100">
        ...
        <div class="w-0.5 bg-black hidden sm:block">
            ...
            <div class="bg-red-600 text-white p-2 w-1/2 sm:w-1/5 flex rounded-sm sm:ml-4 font-bold justify-center mt-2 mb-2 sm:mt-0 sm:mb-0">
            <?php
