  ...
  <div class="relative w-auto my-6 mx-auto max-w-3xl">
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <div class="grid text-center  justify-between p-5  rounded-t relative">
        <button class="text-red-500 bg-primary font-bold uppercase p-2 mr-1 mb-1 ease-linear transition-all duration-150 absolute" type="button" onclick="toggleModal('modal-id')">
          X
        </button>
