<button id="moving-buy-button" class="bg-primary w-full rounded-full p-4md:p-8 text-center block md:flex justify-center text-black align-center drop-shadow-md shadow-primary  ">
    <?php
