        ...
        <div class="md:!w-1/2 w-full">
            <div id="product-info" class="border-4 border-primary !rounded-lg border-t-40 ">
                ...
                <div class="font-bold">4.92 / 5 based on 241 reviews</div>
                    ...
                    if($price_sales > 0){
                        echo "<div class='text-red-500 text-2xl mr-2 ml-2 font-bold uppercase'> only " . "$"  . $price_sales ."</div>" ."<div class='text-red-500 text-base mr-2 font-bold uppercase'> today" . "&nbsp" . "</div>" . "<div class='text-xs mr-2 ml-2 mt-1 font-medium line-through'>" .  "LIST PRICE" . " $" .  $price . "</div>";
                    }
                    else{
                        echo $price . "$";
                    }
