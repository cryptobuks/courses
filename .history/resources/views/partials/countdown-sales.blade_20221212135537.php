<div class="timer" x-data="timer(new Date().setDate(new Date().getDate() + 1))" x-init="init();">
    <div class="countdown ml-4 absolute -top-6 right-0">
      <div class="countdown-number">
        ...
        <div class="font-bold	text-[8px] leading-tight">Days</div>
      </div>
      <div class="countdown-number">
        <div  x-text="time().hours"></div>
        <div class="font-bold	text-[8px] leading-tight">Hours</div>
      </div>
      <div class="countdown-number">
        <div  x-text="time().minutes"></div>
        <div class="font-bold	text-[8px] leading-tight">Minutes</div>
      </div>
      <div class="countdown-number">
        <div  x-text="time().seconds"></div>
        <div class="font-bold	text-[8px] leading-tight">Seconds</div>
      </div>
    </div>
