<div class="flex flex-wrap">
        ...
        <div class="md:!w-1/2 w-full">
            <div id="product-info" class="border-4 border-primary !rounded-lg border-t-40 relative">
                <div class="bg-primary p-2 relative">
                   ...
                   @include('partials.countdown-sales')
                    ...
                    <div class=" block !rounded-lg p-1 md:!pl-10 md:!pr-10">
                        <div class="fill-primary flex h-4 items-center justify-center">
                            ...
                            <?php
                                ...
                                if($price_sales > 0){
                                    echo "<div class='text-red-500 text-xl mr-2 ml-2 font-bold uppercase'> only " . "$"  . $price_sales ."</div>" ."<div class='text-red-500 text-xl mr-2 font-bold uppercase'> today" . "&nbsp" . "</div>" . "<div class='text-xs mr-2 ml-2 mt-1 font-medium line-through flex items-center'>" .  "LIST PRICE" . " $" .  $price . "</div>";
                                }
                                else{
                                    echo $price . "$";
                                }
            ...
            <div class="mt-16 grid justify-items-center">
                <div class="flex">
