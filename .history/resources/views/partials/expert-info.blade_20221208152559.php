<div class="flex flex-row bg-white justify-between mt-2">
    <div class="flex">
        ...
        <div class="ml-4 inline-flex items-center">
            <div class=" font-bold text-xl">{{$expertName}} <img class="h-4 mt-2 ml-2" src="/wp-content/themes/courses-1/resources/images/check-blue.png"></img></div>
            <div class=" text-stone-500	">{{$expertJob}}</div>
        </div>
        <img class="h-14"src="{{$bestSellingAuthorBadge}}"></img>
    </div>
</div>
<div class="flex -mt-5">
