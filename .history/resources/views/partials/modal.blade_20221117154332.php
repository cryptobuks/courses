  ...
  <div class="relative w-auto my-6 mx-auto max-w-3xl">
    ...
    <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none ">
      ...
      <div class="grid text-center  justify-between  rounded-t relative">
        <button class="text-white bg-primary font-bold uppercase p-2 rounded-full w-8.5 text-sm absolute right-4 top-2 z-50" type="button" onclick="toggleModal('modal-id')">
          X
        </button>
