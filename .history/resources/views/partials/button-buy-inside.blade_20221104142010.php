<button id="moving-buy-button" class="px-6 py-2 font-semibold text-black border-b-4 rounded-full shadow-lg bg-primary border-cyan-800 shadow-secundary hover:border-cyan-600">
    <?php
