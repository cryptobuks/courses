...
$(document).ready(function() {
    $("#div_block-125-136402").insertBefore("#payment");
...
<div id="fast-delivery">
    @include('icons.clock')
    <div class="text-xs">Choose to pay via credit card or Paypal for instant access to content without complications with the mail.</div> 
</div>
<div class="md:flex justify-between p-4 inline" id="money-back">
    <img class="h-10" src="/wp-content/themes/courses-1/resources/images/verified.png"></img>
</div>
<!--
