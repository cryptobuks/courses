...
<?php
        ...
        <div class="flex-auto relative lg:shadow rounded p-4 mt-4 flex">
            <div>
                <img class="h-14" src="{{$testimonialImageCheckout}}"></img>
                <div class='flex mb-5 max-w-contentwidth fill-primary'>{{$testimonialNameCheckout}}
                </div>
            </div>
            <div class="text-2xl font-bold w-3/5">{{$testimonialHeadlineCheckout}}</div>
        </div>
