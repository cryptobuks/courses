...
<section class="max-w-pageWidth m-auto flex">
<div class="lg:shadow rounded p-8 w-64 !md:w-1/2">
...
<section class="container mx-auto pageWidth max-w-pageWidth p-4 flex" >
