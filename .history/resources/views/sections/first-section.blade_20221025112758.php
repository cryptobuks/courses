...
<section class="container mx-auto p-4">
    <h3 class="w-full justify-items-center font-bold text-center p-4 !text-4xl">{{$heading}}</h3>
    <h1 class="w-full justify-items-center text-black text-center mb-4 !text-2xl">{{$subheading}}</h1>
