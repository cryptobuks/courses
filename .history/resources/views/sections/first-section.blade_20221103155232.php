...
<section class="mx-auto p-4 max-w-pageWidth">
    <div class="w-full  m-auto">
        <h3 class="w-full justify-items-center !font-bold md:text-center text-left md:p-4 text-4xl md:!text-6xl mb-4 text-black">{{$heading}}</h3>
        <h1 class="w-full justify-items-center !font-normal text-black md:text-center text-left mb-4 !text-xl md:!text-2xl">{{$subheading}}</h1>
    ...
    <div class="flex flex-wrap">
        ...
        <div class="border-4 border-primary rounded border-t-40 md:!w-1/2 w-full">
            <div class="bg-primary p-4">
                ...
                <div class=" block rounded-full pl-4 pr-4 pt-4 md:!pl-10 md:!pr-10">
