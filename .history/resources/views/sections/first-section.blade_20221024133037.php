...
<section class="container mx-auto p-4">
    ...
    <div class="flex flex-row mx-auto">
        ...
        <div class="flex-auto ml-2 border-4 border-primary rounded border-t-40 w-32">
            ...
            if($price_sales > 0){
                echo "<div class='text-red-500 text-2xl mr-2 ml-2 font-semibold'> only today " . "$"  . $price_sales . "&nbsp" . "</div>" . "<div class='text-xl mr-2 ml-2 font-medium line-through'>" . "$" . $price . "</div>";
            }
            else{
                echo $price . "$";
            }
