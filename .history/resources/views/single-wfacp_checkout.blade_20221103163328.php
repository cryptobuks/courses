...
<section class="max-w-pageWidth m-auto">
    <div class="flex flex-wrap">
                    ...
                    while(have_rows('testimonial_checkout')): the_row();
                        ...
                        <div class="block relative lg:shadow rounded p-6 mt-4 ">
                            <div class="flex flex-row align-middle">
                                ...
                                <div class="text-2xl font-bold ml-6 mb-4">{{$testimonialHeadlineCheckout}}</div>
                            </div>
        ...
        <div class="md:!w-1/2 w-full p-2 ">
            <div id="checkout-timer" class="bg-black text-white p-4 mb-10">Your order is reserver for: @include('partials.countdown-checkout')</div>
        @php(the_content())
        </div>
    </div>
