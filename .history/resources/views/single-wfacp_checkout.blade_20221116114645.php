...
$(document.body).on('updated_checkout', function () {
    ...
    $(".woocommerce-checkout-review-order.wfacp-oder-detail.clearfix > .wfob_bump_wrapper.woocommerce_checkout_order_review_below_payment_gateway").hide();    


    //$("#headline-114-52320").insertAfter('.wc_payment_methods.payment_methods.methods').css("display","inline-flex");
});
if (jQuery(window).width() < 768) {
    	jQuery("#div_block-269-1620").insertBefore("#shortcode-184-1620");
	
		/* PRESTAVI GOOGLE/APPLE PAY POD MINI CART < 768PX */
	 	jQuery("#wc-stripe-payment-request-wrapper").insertAfter("#shortcode-183-1620");
    	...
    	jQuery("#div_block-269-1620").insertBefore("#div_block-141-1620");
