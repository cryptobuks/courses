...
$(document.body).on('updated_checkout', function () {
    ...
    $(".wfacp-order-summary-label h2").text("Order Summary");
...
if ($(window).width() < 768) {
        ...
        $(".wfob_bump_wrapper.woocommerce_checkout_order_review_below_payment_gateway").insertAfter("#div_block-174-1620");
