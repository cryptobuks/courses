...
<div class="font-inter max-w-7xl flex flex-col lg:h-screen justify-center items-center mx-2 xl:mx-auto my-4 xl:my-auto">

  <h1 class="text-2xl lg:text-5xl font-black text-center">
    Best-selling author of 16 parenting books reveals how to get your kids to listen without yelling
  </h1>

  <p class="text-base lg:text-2xl font-semibold text-center py-6">
  ...
  <div class="flex flex-col md:flex-row">
    <div class="w-full md:w-55% ">
      <img src="@asset('./images/image-sage.png')" alt="">
    </div>
    <div class="w-full md:w-45% relative">
      <div class="box-border bg-softorange px-2 pb-2 shadow-softorange rounded-5px flex flex-col rounded lg:absolute bottom-0">
        <h2 class="text-base md:text-2xl text-white text-center font-semibold py-1">28-Day No-Yelling Challenge</h2>
        <div class="bg-white w-full p-2 rounded-5px flex-grow">
          <p class="text-softred text-base text-center font-bold">ONLY 37$ TODAY <span class="line-through text-black text-xs font-normal">LIST PRICE 100$</span></p>
          <ul class="text-xs my-6">
            <li class="leading-loose"> 
              <img src="@asset('./images/Vector.svg')" alt="" class="mr-1 inline"><b>28 no-yelling tools </b> that will help you stop yelling at your kids;
            </li>
            <li class="leading-loose">
              <img src="@asset('./images/Vector.svg')" alt="" class="mr-1 inline"><b>28 daily 5-minute </b> e-mails that will help you raise your kids in a calm, respectful way;
            </li>
            <li class="leading-loose">
              <img src="@asset('./images/Vector.svg')" alt="" class="mr-1 inline"><b>concrete instructions </b> that will help you start using the no-yelling tools the same day;
            </li>
            <li class="leading-loose">
              <img src="@asset('./images/Vector.svg')" alt="" class="mr-1 inline"><b>practical examples </b> from real-world situations that every parent can relate to;
            </li>
            <li class="leading-loose">
              <img src="@asset('./images/Vector.svg')" alt="" class="mr-1 inline"><b>daily reminders </b> that will help you stay on track and become a better parent every day.
            </li>
          </ul>
          <div class="rating flex">
            ...
            @endfor
            <span class="text-sm md:text-base font-bold px-2">4.92 / 5 based on 241 reviews</span>
          </div>
          <div class="flex justify-center items-center flex-col mt-6 -my-9">
            <span class="text-softgray text-xs font-light m-1">Now Available For Instant Access</span>
            <button class="bg-neongreen text-white w-200px h-53px rounded-lg leading-none outline outline-offset-5 outline-2">
              SIGN UP TODAY<br>
              <span class="text-xxs font-thin">AND GET INSTANT ACCESS</span>
            </button>
          </div>
        </div>
      </div>
  ...
  <div class="relative w-full mt-8 md:mt-0">
    <img src="@asset('./images/author.png')" alt="" class="rounded-100">
    <img src="@asset('./images/best-seller.png')" alt="" class="w-22 absolute top-10 left-9">
  </div>
</div>
