...
function my_acf_add_local_field_groups() {
	...
	acf_add_local_field_group(array(
		...
		'fields' => array (
            ...
            array (
				'key' => 'field_14',
				'label' => 'Toggle text yellow box',
				'name' => 'toggle_text_yellow_box',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
            ...
            array (
				'key' => 'field_16',
				'label' => 'Toggle about me',
				'name' => 'toggle_about_me',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
            ...
            array (
				'key' => 'field_17',
				'label' => 'Toggle basic testimonials',
				'name' => 'toggle_basic_testimonials',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
            ...
            array (
				'key' => 'field_19',
				'label' => 'Toggle unlimited access',
				'name' => 'toggle_unlimited_access',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
            ...
            array (
				'key' => 'field_20',
				'label' => 'Toggle facebook',
				'name' => 'toggle_facebook',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
            ...
            array (
				'key' => 'field_23',
				'label' => 'Toggle testimonials',
				'name' => 'toggle_testimonials',
				'type' => 'true_false',
                'default_value' => 0,
                'ui' => 1,
                'ui_on_text' => 'Display',
...
function myplugin_settings() {  
	...
	register_taxonomy_for_object_type('category', 'single-wfacp_checkout');  
	register_taxonomy_for_object_type('category', 'postid-56');  
	register_taxonomy_for_object_type('category', 'wfacp_page_loaded');  
	register_taxonomy_for_object_type('category', 'customize-support');  
