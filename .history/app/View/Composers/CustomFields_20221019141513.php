...
class CustomFields extends Composer
{
    ...
    public function with()
    {
        return [
            ...
            'productFaqCheckout' => $this->productFaqCheckout(),  
            ...
            'yellowBoxTitleUpsell' => $this->yellowBoxTitleUpsell(),  
            'toggleYellowBoxTitleUpsell' => $this->toggleYellowBoxTitleUpsell(),  
            'yellowBoxSubtitleUpsell' => $this->yellowBoxSubtitleUpsell(),  
            'toggleYellowBoxSubtitleUpsell' => $this->toggleYellowBoxSubtitleUpsell(),  
            'yellowBoxImageUpsell' => $this->yellowBoxImageUpsell(),  
            'yellowBoxContentUpsell' => $this->yellowBoxContentUpsell(),  
            'toggleYellowBoxSubtitleUpsell' => $this->toggleYellowBoxSubtitleUpsell(),  
            'toggleYellowBoxSubtitleUpsell' => $this->toggleYellowBoxSubtitleUpsell(),  
        ];
    }
    ...
    public function imageYellowBox(){
        return get_field("image_yellow_box");
    }
    ...
    public function productFaqCheckout(){
        if(have_rows("product_faq_checkout")):
            while(have_rows("product_faq_checkout")) :the_row();
              $productFaqQuestionCheckout = get_sub_field("product_faq_question_checkout");  
              $productFaqAnwserCheckout = get_sub_field("product_faq_anwser_checkout");  
            endwhile;
        endif;
    }
    /* UPSELL PAGE */
    ...
    public function yellowBoxTitleUpsell(){
        return get_field("yellow_box_title_upsell");
    }
    public function toggleYellowBoxTitleUpsell(){
        return get_field("toggle_yellow_box_title_upsell");
    }
    public function yellowBoxSubtitleUpsell(){
        return get_field("yellow_box_subtitle_upsell");
    }
    public function toggleYellowBoxSubtitleUpsell(){
        return get_field("toggle_yellow_box_subtitle_upsell");
    }
    public function yellowBoxImageUpsell(){
        if(get_field("yellow_box_image_upsell")){
            return get_field("yellow_box_image_upsell")['url'];
        }
    }
    public function yellowBoxContentUpsell(){
        return get_field("yellow_box_content_upsell");
    }
