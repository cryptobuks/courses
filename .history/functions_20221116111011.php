...
<style>
	...
	body .wfob_wrap_start .wfob_checkbox:checked:before {
			...
			background: url("body .wfob_wrap_start .wfob_checkbox:checked:before {
			content: "\f147";
			margin: -3px 0px 0px -2px!important;
			color: transparent;
			float: left;
...
icon-check-green.png") center center!important;
			margin-top: -3px;
			margin-left: -2px;
			background-size: contain!important;
		}
...
add_action( 'after_setup_theme', function () {
	...
	new WFOB_Add_New_Position( [
		'position_id'   => 'wfob_random',// Random ID 
		'hook'          => 'wfacp_before_billing_email_field',
		'position_name' => 'Above Email fields',
		'hook_priority' => 21
	] );
