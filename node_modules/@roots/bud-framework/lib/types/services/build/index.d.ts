...
export interface Service extends BaseService {
     ...
     * @public
     */
    setLoader<K extends `${keyof Loaders & string}`>(name: K, options?: string | Loader): Service;
    /**
     ...
     * @public
     */
    setItem<K extends `${keyof Items & string}`>(name: K, options?: Partial<Item.Options> | ((item: Item) => Item)): Service;
    /**
