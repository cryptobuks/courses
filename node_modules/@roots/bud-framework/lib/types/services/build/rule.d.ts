...
export interface Options {
    ...
    use?: ((loaders: Array<Item | `${keyof Build.Items & string}`>) => Array<Item | `${keyof Build.Items & string}`>) | Array<Item | `${keyof Build.Items & string}`>;
...
export interface Interface extends Base {
     ...
     * @public
     */
    setUse(use: Array<`${keyof Build.Items & string}` | Item> | ((use: Array<`${keyof Build.Items & string}` | Item>) => Array<`${keyof Build.Items & string}` | Item>)): this;
    /**
     * Use item
     *
     * @public
