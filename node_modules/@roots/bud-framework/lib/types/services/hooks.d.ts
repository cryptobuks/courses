...
export interface Service extends BaseService {
     ...
     * @public
     */
    on: <T extends keyof Hooks.SyncStore & string>(id: T, input: Hooks.SyncCallback[T]) => Bud;
    /**
     ...
     * @public
     */
    async: <T extends keyof Hooks.AsyncStore>(id: T, value: Hooks.AsyncCallback[T]) => Bud;
    /**
     * Register a recordset of functions or values to modify or replace existing values
     *
     * @example
     ...
     * @public
     */
    filter: <T extends keyof Hooks.SyncStore>(id: T, callback?: Hooks.SyncCallback[T]) => Hooks.SyncRegistry[T];
    /**
     ...
     * @public
     */
    filterAsync: <T extends keyof Hooks.AsyncRegistry & string>(id: T, fallback?: Hooks.AsyncCallback[T]) => Promise<Hooks.AsyncRegistry[T]>;
    /**
     * Execute an action
     *
     * @public
     */
    fire: <T extends `${keyof Hooks.EventsStore & string}`>(id: T) => Promise<Bud>;
    /**
     * Store callback to an action handler
     *
     * @public
     */
    action: <T extends keyof Hooks.EventsStore & string>(id: T, ...input: Array<Hooks.EventsCallback>) => Bud;
}
