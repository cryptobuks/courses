 ...
 * @public
 */
const isset = (value) => !isUndefined(value);
/**
 * Override build with args set via CLI
 *
 * @public
 */
export const override = async (app) => {
    ...
    if (isset(app.context.args.publicPath))
        ...
        app.hooks.on(`build.output.publicPath`, app.context.manifest.bud.publicPath);
    ...
    if (isset(app.context.args.storage))
        ...
        app.hooks.on(`location.@storage`, app.context.manifest?.bud.paths[`@storage`]);
