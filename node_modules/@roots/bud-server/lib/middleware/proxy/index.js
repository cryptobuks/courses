...
export const proxy = (app) => {
    ...
    const options = {
         ...
         * Log level
         */
        logLevel: app.hooks.filter(`dev.middleware.proxy.options.logLevel`, `info`),
        /**
         * Log provider
         */
         ...
         */
        onProxyReq: app.hooks.filter(`dev.middleware.proxy.options.onProxyReq`, request.make),
        /**
         * Proxy response handler
         */
        onProxyRes: app.hooks.filter(`dev.middleware.proxy.options.onProxyRes`, response.make),
        /**
         * Protocol rewrite
         */
        protocolRewrite: app.hooks.filter(`dev.middleware.proxy.options.protocolRewrite`, url.dev.protocol === `https:` ? `https` : null),
        /**
         * Secure
         */
    ...
    return createProxyMiddleware(app.hooks.filter(`dev.middleware.proxy.paths`, [`**`, `!/__bud/**`]), app.hooks.filter(`dev.middleware.proxy.options`, options));
};
