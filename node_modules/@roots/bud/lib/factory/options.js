export const mergeOptions = (context, overrides) => {
    return {
        ...context,
        ...(overrides ?? {}),
        ...
        extensions: Array.from(new Set([...context.extensions, ...(overrides?.extensions ?? [])])),
        services: Array.from(new Set([...context.services, ...(overrides?.services ?? [])])),
