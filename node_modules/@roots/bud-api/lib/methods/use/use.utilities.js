 ...
 * @internal
 */
export const isPlugin = (extension) => extension.apply &&
 ...
 * @internal
 */
export const hasValidConstructorName = (input) => input?.constructor?.name &&
 ...
 * @internal
 */
export const generateName = (input) => hasValidConstructorName(input) ? input.constructor.name : nanoid(4);
//# sourceMappingURL=use.utilities.js.map