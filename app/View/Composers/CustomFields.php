...
class CustomFields extends Composer
{
    ...
    public function with()
    {
        return [
            ...
            'toggleTextYellowBox' => $this->toggleTextYellowBox(),
            'secondContent' => $this->secondContent(),
            'toggleAboutMe' => $this->toggleAboutMe(),
            'toggleBasicTestimonials' => $this->toggleBasicTestimonials(),
            'toggleMoneyBack' => $this->toggleMoneyBack(),
            'toggleUnlimitedAccess' => $this->toggleUnlimitedAccess(),
    ...
    public function toggleTitleYellowBox(){
        return get_field("show_hide_title_yellow_box");
    }
    public function subtitleYellowBox(){
        return get_field("subtitle_yellow_box");
    }
    public function toggleSubtitleYellowBox(){
        return get_field("show_hide_subtitle_yellow_box");
    }
    public function textYellowBox(){
        return get_field("text_yellow_box");
    }
    public function toggleTextYellowBox(){
        return get_field("show_hide_text_yellow_box");
    }
    public function secondContent(){
        return get_field("second_content");
    }
    public function toggleAboutMe(){
        return get_field("show_hide_about_me");
    }
    public function toggleBasicTestimonials(){
        return get_field("show_hide_basic_testimonials");
    }
    public function toggleMoneyBack(){
        return get_field("show_hide_money_back");
    }
    public function toggleUnlimitedAccess(){
        return get_field("show_hide_unlimited_access");
    }
    public function toggleFacebook(){
        return get_field("show_hide_facebook");
    }
    public function productTestimonials(){
        if(have_rows("product_testimonials")):
            while(have_rows("product_testimonials")) :the_row();
              $productTestimonialName = get_sub_field("product_testimonials_name");  
              $productTestimonialText = get_sub_field("product_testimonials_text"); 
              $productTestimonialImage = get_sub_field("product_testimonials_image");  
            endwhile;
        endif;
    }
    public function toggleTestimonials(){
        return get_field("show_hide_product_testimonials");
    }
    public function productFaq(){
        if(have_rows("product_faq")):
            while(have_rows("product_faq")) :the_row();
              ...
              $productFaqText = get_sub_field("product_faq_text"); 
            endwhile;
        endif;
    }
    ...
    public function toggleWhatYouGetSubtitle(){
        return get_field("show_hide_what_you_get_subtitle");
    }
    ...
    public function logoColor(){
        return get_field("logo_color", 'options')['url'];
    }
    public function logoWhite(){
        return get_field("logo_white");
    }
