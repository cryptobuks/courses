<button id="moving-buy-button" class="px-6 py-2 font-semibold text-black border-b-4 rounded-full shadow-lg bg-primary border-black shadow-black-600/50 hover:border-primary">
    <?php
